...
/*
 * $Id: trackbar.h 7365 2007-08-16 05:22:17Z xgwang $
 *
...
#ifndef _MY_CTRL_TRACKBAR
#define _MY_CTRL_TRACKBAR
...
typedef  struct tagMYTRACKBARDATA
{
    int nMin;
    int nMax;
    int nPos;
...
typedef MYTRACKBARDATA* PMYTRACKBARDATA;
