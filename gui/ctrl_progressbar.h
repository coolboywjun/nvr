...
/*
 * $Id: progressbar.h 7365 2007-08-16 05:22:17Z xgwang $
 *
...
#ifndef _MGUI_CTRL_PROGRESSBAR_EX_H
#define _MGUI_CTRL_PROGRESSBAR_EX_H
 ...
 */
#define CTRL_PROGRESSBAR_EX        ("progressbar_ex")
...
typedef  struct tagPROGRESSDATA_EX
{
    int nMin;
    int nMax;
    int nPos;
...
typedef PROGRESSDATA_EX* PPROGRESSDATA_EX;
