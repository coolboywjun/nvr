...
/*huangh add*/
#define LVIF_BLANK		 0x0010L
#define LVIF_CHECKED 	 0x0020L
#define LVIF_PARTCHECKED 0x0040L
#define LVIF_CHECKMASK   0x00F0L
...
typedef struct _lsthdr
{
    ...
    DWORD		  checkFlags;	//header's checkmark flags	
} LSTHDR;
