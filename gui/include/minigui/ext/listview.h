...
/**huangh Listview ch
 *Listview checkbox flag
 */

#define LVFLAG_BLANK            0x0010
#define LVFLAG_CHECKED          0x0020
#define LVFLAG_PARTCHECKED      0x0040
...
typedef struct _LVCOLUMN
{
	...
	/*huangh add: header checkmark flags*/
	DWORD checkFlags;
...
/*huangh add: checkmark flags */
#define LVI_HEADER_UNCHECK		0x0000L

#define LVI_HEADER_BLANK	 	0x0010L
#define LVI_HEADER_CHECK	 	0x0020L
#define LVI_HEADER_PARTCHECK 	0x0040L
#define LVI_HEADER_CHECKMASK    0x00F0L
...
#define LVM_GETCHECKMARK		0xF150
#define LVM_SETCHECKMARK		0xF151
#define LVM_GETEDITEM    		0xF152
#define LVM_SETHEAD_CHECKMARK   0xF153
#define LVM_GETHEAD_CHECKMARK   0xF154
...
#define LVN_ITEM_STARTDRAG		14
#define LVN_ITEM_STOPDRAG		15
#define LVN_ITEM_DRAGGING		16

/**
 * \def LVN_CLICKCHECKMARK
 * \brief Indicates click on the check mark.
 */
#define LVN_CLICKCHECKMARK		17

/**
 * \def LVN_SELCANCEL
 * \brief Indicates cancel of the selection in the list view.
 */
#define LVN_CHECKBOX_SELCANCEL           18

#define LVN_CHECKBOX_SELECT				 19

#define LVN_CHECKBOX_UNSELECTALL		 20

#define LVN_CHECKBOX_SELECTALL			 21
