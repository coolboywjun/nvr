...
/*
 * $Id: propsheet.h 7365 2007-08-16 05:22:17Z xgwang $
 *
...
#ifndef _MY_CTRL_PROPSHEET_H
#define _MY_CTRL_PROPSHEET_H
 ...
 */
#define MY_PROPSHEET       ("mypropsheet")
...
typedef struct tagMYPROPPAGE
{
    ...
    struct tagMYPROPPAGE* next;   /* next page */
} MYPROPPAGE;
typedef MYPROPPAGE* PMYPROPPAGE;

typedef struct tagMYPROPSHEETDATA
{
    RECT     head_rc;            /* height of page title */
    int      head_width;         /* the effective width of head */
    int      page_count;         /* the number of pages */
    MYPROPPAGE *active;            /* index of active page */
    MYPROPPAGE *first_display_page;/* index of active page */
    MYPROPPAGE *head;              /* head of page list */
    BOOL     overload;           /* if too much head and 
                                    too long for display, 
                                    head_overload = TRUE */
} MYPROPSHEETDATA;
typedef MYPROPSHEETDATA* PMYPROPSHEETDATA;

BOOL RegisterMyPropSheetControl (void);
void MyPropSheetControlCleanup (void);
