...
#ifndef _MGUI_MY_LISTBOX_H
#define _MGUI_MY_LISTBOX_H
...
typedef struct _MYLISTBOXITEMINFO
{
    /** Item string */
    char* string;
 ...
 */
typedef MYLISTBOXITEMINFO* PMYLISTBOXITEMINFO;
...
typedef struct _MYLISTBOXITEM 
{
    char*   key;                // item sort key
    DWORD   dwFlags;            // item flags
    DWORD   dwImage;            // item image
    DWORD   dwAddData;          // item additional data
    struct  _MYLISTBOXITEM* next; // next item
} MYLISTBOXITEM;
typedef MYLISTBOXITEM* PMYLISTBOXITEM;
...
typedef struct tagMYLISTBOXDATA
{
    ...
    MYLISTBOXITEM* head;      // items linked list head

    int buffLen;            // buffer length
    MYLISTBOXITEM* buffStart; // buffer start
    MYLISTBOXITEM* buffEnd;   // buffer end
    MYLISTBOXITEM* freeList;  // free list in buffer 
    SBPolicyType sbPolicy;  // scrollbar policy type
    
    PLOGFONT lst_font;       // logic font for bold display 
} MYLISTBOXDATA;
typedef MYLISTBOXDATA* PMYLISTBOXDATA;   
