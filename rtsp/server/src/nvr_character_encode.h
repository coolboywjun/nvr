...
* All rights reserved.
*
* filename:nvr_character_encode.h
*
...
#define HASHHEALEXEN      32
	...
	void nvr_md5_auth_cvt_hex(HASH bin, HASHHEX hex);

	void nvr_md5_auth_digest_calc_hA1(const char *authId, const char *password,
	                                  unsigned char alg, const char *realm, const char *nonce,
	                                  const char *cnonce, HASHHEX sessionKey);

	void nvr_md5_auth_digest_calc_response(HASHHEX ha1, const char *nonce, const char *nc,
