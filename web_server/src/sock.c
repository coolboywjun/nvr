 ...
 */
	...
	//int ret1 = ringqOpen(&sp->inBuf, SOCKET_BUFSIZ, SOCKET_BUFSIZ);
	int ret1 = ringqOpen(&sp->inBuf, 16384, 16384);
	int ret2 = ringqOpen(&sp->outBuf, SOCKET_BUFSIZ + 1, SOCKET_BUFSIZ + 1);
	int ret3 = ringqOpen(&sp->lineBuf, SOCKET_BUFSIZ, -1);
