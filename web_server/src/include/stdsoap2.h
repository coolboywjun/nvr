...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve(struct soap *soap, char *test);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_begin_serve(struct soap*, char *test);
SOAP_FMAC1 int SOAP_FMAC2 soap_begin_recv(struct soap*);
SOAP_FMAC1 int SOAP_FMAC2 soap_begin_recv1(struct soap*, char *test);
